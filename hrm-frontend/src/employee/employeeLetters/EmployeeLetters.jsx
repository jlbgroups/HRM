...
import { Mail, FileText, Eye, Search, BadgeCheck, X } from "lucide-react";
      ...
      {preview && (
        <div className="modal-bg" onClick={() => setPreview(null)}>
          <div className="modal-box" onClick={(e) => e.stopPropagation()}>
            <div style={{ padding: "16px 24px", borderBottom: "1px solid #F1F3F9", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
              <div>
              ...
              <button
                ...
                style={{ width: "32px", height: "32px", borderRadius: "8px", backgroundColor: "#F3F4F6", color: "#6B7280", display: "flex", alignItems: "center", justifyContent: "center", background: "#F3F4F6" }}
              >
                <X size={16} />
              </button>
            </div>
            <div style={{ overflowY: "auto", padding: "28px 24px" }} dangerouslySetInnerHTML={{ __html: getHtml(preview) }} />
          </div>
        </div>
      )}
      ...
      >
        ...
        <div style={{ backgroundColor: "#fff", borderRadius: "14px", border: "1px solid #F1F3F9", boxShadow: "0 2px 8px rgba(15,23,42,0.05)", overflow: "hidden", animation: "fadeUp 0.4s ease both 0.1s" }}>
          <div
            ...
            style={{ padding: "18px 24px", borderBottom: "1px solid #F1F3F9", display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: "12px" }}
          >
            <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
              ...
              <div>
                <h2 style={{ fontSize: "1rem", fontWeight: "600", color: "#111827", margin: 0 }}>Issued Letters</h2>
            ...
            <div className="letters-search-wrap" style={{ position: "relative" }}>
              ...
              <input
                ...
                style={{ padding: "9px 14px 9px 38px", border: "1.5px solid #E5E7EB", borderRadius: "9px", fontSize: "0.875rem", color: "#374151", backgroundColor: "#F9FAFB", fontFamily: "'DM Sans', sans-serif", outline: "none", width: "260px", transition: "border-color 0.18s, box-shadow 0.18s" }}
              />
            </div>
          </div>
          ...
          {loading ? (
            <div style={{ display: "flex", alignItems: "center", justifyContent: "center", minHeight: "260px" }}>
              <div style={{ textAlign: "center" }}>
                <div style={{ width: "40px", height: "40px", border: "3px solid #E5E7EB", borderTop: "3px solid #4F46E5", borderRadius: "50%", animation: "spin 0.8s linear infinite", margin: "0 auto 14px" }} />
                <p style={{ color: "#6B7280", fontWeight: "500", fontSize: "0.875rem" }}>Loading letters...</p>
              </div>
            </div>
          ) : filtered.length === 0 ? (
              ...
              <table className="letters-table" style={{ width: "100%", borderCollapse: "collapse" }}>
                <thead>
                  <tr style={{ backgroundColor: "#F9FAFB" }}>
                    {["Letter Type", "Recipient", "Issued On", "Status", "Action"].map((h) => (
                      <th key={h} style={{ padding: "11px 20px", textAlign: "left", fontSize: "0.72rem", fontWeight: "600", color: "#6B7280", textTransform: "uppercase", letterSpacing: "0.5px", borderBottom: "1px solid #F1F3F9", whiteSpace: "nowrap" }}>
                        {h}
                      </th>
                    ))}
                  </tr>
                ...
                <tbody>
                  {filtered.map((letter, i) => {
                    ...
                    return (
                      <tr key={letter._id} className="letter-row" style={{ backgroundColor: i % 2 === 0 ? "#fff" : "#FAFAFA", borderBottom: "1px solid #F1F3F9" }}>
                        <td data-label="" style={{ padding: "14px 20px" }}>
                          <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                            <div style={{ width: "32px", height: "32px", borderRadius: "8px", backgroundColor: typeStyle.bg, display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                        ...
                        <td data-label="Recipient" style={{ padding: "14px 20px" }}>
                          <p style={{ margin: 0, fontWeight: "500", fontSize: "0.875rem", color: "#111827" }}>{getName(letter)}</p>
                        </td>
                        ...
                        <td data-label="Status" style={{ padding: "14px 20px" }}>
                          <span style={{ display: "inline-flex", alignItems: "center", gap: "5px", padding: "3px 10px", borderRadius: "20px", fontSize: "0.75rem", fontWeight: "600", backgroundColor: "#ECFDF5", color: "#059669" }}>
                            <BadgeCheck size={12} /> Sent
                          </span>
                        </td>
                        <td data-label="Action" style={{ padding: "14px 20px" }}>
                          <button
                            className="icon-btn"
                            onClick={() => setPreview(letter)}
                            style={{ padding: "6px 14px", borderRadius: "7px", backgroundColor: "#EEF2FF", color: "#4F46E5", fontSize: "0.78rem", fontWeight: "600", display: "inline-flex", alignItems: "center", gap: "5px" }}
                          >
