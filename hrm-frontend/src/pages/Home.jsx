              ...
              <div className="shn-stats-grid">
                {stats.map((stat, idx) => (
                  ...
                  >
                    ...
                    <div>
                      <p style={{ fontSize: "0.72rem", color: "#6B7280", fontWeight: 600, textTransform: "uppercase", letterSpacing: "0.4px", margin: "0 0 4px" }}>
                        {stat.label}
                      </p>
            ...
            <div className="shn-container">
              <div className="shn-about-grid">
                ...
                <div className="shn-info-card" style={{ animation: "fadeUp 0.4s ease both 0.2s" }}>
                  <p style={{ fontSize: "0.72rem", fontWeight: 600, color: "#6B7280", textTransform: "uppercase", letterSpacing: "0.5px", margin: "0 0 20px" }}>
                    What We Do
                  </p>
                  {[
          ...
          <section className="shn-section" style={{ background: "#fff" }}>
            <div className="shn-container">
              <div className="shn-testimonial" style={{ animation: "fadeUp 0.4s ease both 0.1s" }}>
                <span role="img" aria-label="5 out of 5 stars" className="shn-stars">
                  {[...Array(5)].map((_, i) => (
